...
async function connectToDatabase() {
  try {
    const uri = process.env.MONGO_URL || "mongodb+srv://damithaliyanaarachchi:ezbusmongo93@cluster0.x8bk2yi.mongodb.net/ezBusDB?retryWrites=true&w=majority&authSource=admin";
